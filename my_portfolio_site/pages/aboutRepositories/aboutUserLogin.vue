...
v-app
  ...
  h2 どうして作ろうと思ったか
  p 普段何気なく使っているログイン機能、外部サービスのAPI等で簡単に実装できるが実際はHTTP(S)通信・セキュリティ面・データベース連携等、様々な技術が使われている。
  |あえて自力でこれらを学びつつログイン機能を作成することで、
  ...
  br
  img(src="/user_registration.gif",alt="ユーザ新規登録")
  ...
  img(src="/encrypted_password.png",alt="暗号化されたパスワード例")
  ...
  img(src="/token_generated.gif",alt="生成されたトークン例")
